    ...
    <div className="mt-4 border-t border-slate-200 pt-4">
      <button
        ...
        className={`flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium transition ${
          isSettingsActive ? "bg-amber-50 text-amber-700" : "text-slate-600 hover:bg-slate-100 hover:text-slate-900"
        }`}
      >
          ...
          <div>
            <button
              ...
              className={`flex w-full items-center gap-2 rounded px-2 py-1.5 text-sm ${
                isHomePageActive ? "font-medium text-amber-700" : "text-slate-600 hover:text-slate-900"
              }`}
            >
              Homepage
              <svg
            ...
            {homeExpanded && (
              <div className="ml-3 space-y-0.5 border-l border-slate-200 pl-2">
                ...
                <Link
                  ...
                  className={`block rounded px-2 py-1.5 text-sm ${
                    pathname === "/admin/settings/home/hero"
                      ? "font-medium text-amber-700"
                      : "text-slate-600 hover:text-slate-900"
                  }`}
                >
                ...
                <Link
                  ...
                  className={`block rounded px-2 py-1.5 text-sm ${
                    pathname === "/admin/settings/home/categories"
                      ? "font-medium text-amber-700"
                      : "text-slate-600 hover:text-slate-900"
                  }`}
                >
